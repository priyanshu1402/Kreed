...
import Endliveroom from '../Components/Endliveroom'
        ...
        <View style={{ flex: 1, backgroundColor: 'black' }} >
            ...
            <TouchableOpacity style={styles.StartGameButton} onPress={()=>{
                ...
                <LinearGradient colors={['#63A140', '#111C0B']}
                    ...
                    <Text style={styles.StartGameButtonText}>{isinningover?"End Match":"Innings Over"}</Text>
                </LinearGradient>
            </TouchableOpacity>
            ...
            <>
                ...
                {data === "throw" ? <OverThrowModal setstatus={setstatus} setvalue={setvalue}/> :
                    data === "stumped" ? <Stumped setstatus={setstatus} setvalue={setData} /> :
                        data === "legbyes" ? <LegByesModal setstatus={setstatus} setvalue={setvalue} /> :
                            data === "no-ball" ? <NoBallModal setstatus={setstatus} setvalue={setvalue} /> :
                                data === "wide" ? <WideBall setstatus={setstatus} setvalue={setvalue} /> :
                                 data === "caught" ? <CoughtByModal setstatus={setstatus} setvalue={setData}/> : 
                                 data==="endmatch"?<EndMatch  setstatus={setstatus} setData={setData}/>:
                                 data==="endvote"?<Endliveroom setstatus={setstatus} setData={setData}/>:null}
            </>
