        ...
        <LinearGradient
          ...
          <View style={{flexDirection: 'row', width: '100%', flex: 1}}>
            <TouchableOpacity
              ...
              <Text style={styles.subheading}>Create</Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => navigation.navigate('Room')}
              style={{
              ...
              <Text style={styles.subheading}>Join</Text>
            </TouchableOpacity>
          </View>
        </LinearGradient>
        <Image style={styles.photo} source={require('../Assets/cricket.png')} />
        <LinearGradient
          style={styles.gameselectbox}
          colors={['rgba(0,0,0,0.5)', '#5e7137', '#5e7137', 'rgba(0,0,0,0.5)']}
          start={{x: 0, y: 0}}
